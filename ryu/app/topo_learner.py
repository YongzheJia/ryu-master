...
class SimpleSwitch13(app_manager.RyuApp):
    ...
    #     # print links
    #
    #     # if len(links) == 2 ** (self.depth + 1) - 4 and self.e == 0:
    #     #     e_time = time.time()
    #     #     # print "e_time:", e_time
    ...
    # #     if switch_num == 2 ** self.depth-1 and self.s == 0:
    # #         self.s = 1
    # #         self.s_time = time.time()
    # #         print "s_time:", self.s_time
    #     pass

    # @set_ev_cls([event.EventLinkAdd, event.EventLinkDelete, event.EventLinkBase, event.EventLinkReply])
    ...
    #     # switch_num = len(switches)
    #
    #     if len(links) == 2 ** (self.depth + 1) - 4 and self.one_round == 0:
    #         e_time = time.time()
    #         total_time = e_time-self.s_time
    #
    #         # self.s = 1
